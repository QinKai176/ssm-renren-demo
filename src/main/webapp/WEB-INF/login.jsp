					...
					<div class="navigation navigation-new clearfix">
						...
						<div class="nav-body clearfix">
							<div class="nav-other">
								...
								<div class="menu">
									<a id="reg_link" title="注册" stats="homenav_reg" href="register.action">注册</a>
								</div>
								<div class="menu">
...
<form method="post" id="loginForm" class="login-form" action="tologin.action">
...
<div class="Third-partyi-login">
	<a title="微信" class="login-item weixin" href="http://www.renren.com/api/jump?src=wx" id="login_weixin" stats="loginPage_weixin_link"></a>
	 ...
	 <a href="adminlogin.action" title="管理员"><img src="img/adminicon.jpg" style="padding-left: 64px;padding-top: 14px;"></a>
</div>
</div>
